...
* Reduce recurring user account-lockout incidents.
* Improve password-reset processes.
* Strengthen identity and access management.
* Improve troubleshooting efficiency.
* Automate repetitive helpdesk activities.
* Improve ICT service delivery and user productivity.
* Maintain secure and reliable access to organizational resources.
...
| Technology       | Purpose                                  |
| ---------------- | ---------------------------------------- |
| Windows Server   | Server and directory infrastructure      |
| Active Directory | Identity and account management          |
| Group Policy     | Centralized configuration and security   |
| DNS              | Network name resolution                  |
| DHCP             | Automatic network configuration          |
| PowerShell       | Administration and automation            |
| Microsoft 365    | Cloud identity and productivity services |
...
Performed administration and support activities including:
...
Supported centralized security and configuration management using Group Policy, including:
...
Supported core Windows network services including:
...
Typical investigation steps included:

1. Identify the affected user account.
2. Check the account status in Active Directory.
...
The automation approach helped to:

* Reduce manual administrative work.
* Improve password-reset response times.
* Standardize repetitive support activities.
...
This approach helps ensure that recurring authentication problems are investigated at their source rather than repeatedly treated as simple password-reset requests.
...
| Improvement                                    |                Result |
| ---------------------------------------------- | --------------------: |
| Active Directory account-lockout reduction     |               **25%** |
| Support time saved through password automation |    **42 hours/month** |
| Password-reset process                         | **More standardized** |
| Authentication troubleshooting                 |          **Improved** |
| Helpdesk workload                              |           **Reduced** |
...
All examples are presented for professional portfolio and educational purposes.
